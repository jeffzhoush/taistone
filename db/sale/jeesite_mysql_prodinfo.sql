...
(
	...
	forwarderprice numeric(12,4) COMMENT '出车价',
	storeprice numeric(12,4) COMMENT '现销价',
	twosalesprice numeric(12,4) COMMENT '二批价',
	creditprice numeric(12,4) COMMENT '赊销价',
	salesorder numeric(2,0) COMMENT '排序',
