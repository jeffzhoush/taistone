...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sale/market/carinfo/">车辆列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="carinfo" action="${ctx}/sale/market/carinfo/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="licence" htmlEscape="false" maxlength="20"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">装载上限:</label>
			<div class="controls">
				<form:input path="loadup" htmlEscape="false" maxlength="20" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">装载下限:</label>
			<div class="controls">
				<form:input path="loaddown" htmlEscape="false" maxlength="20"/>
			</div>
		</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sale:market:carinfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
