...
<body>
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="${ctx}"><img src="${ctxStatic}/images/logo.png" alt="Taistone Admin" style="height:40px;"></a>
        </div>
      </div>
    </div>
    ...
    <footer class="white navbar-fixed-bottom">
		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="https://www.taistone.com" target="_blank">Taistone</a> ${fns:getConfig('version')}
    </footer>
  </body>
</html>